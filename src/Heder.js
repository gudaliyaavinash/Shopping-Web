...
import { SerchCart } from "./counter/counterSlice";
            ...
            <div className="flex items-center max-_350_:justify-between py-2 gaap mx-4">
              <div className="w-[30%] w-img max-_377_:gap-[5px] just-between flex items-center">
                <div id="add" className="p-r me-2">
                  ...
                  <div className="">
                    <ul className=" menu  p-0 demo p-a z-[999]">
                      <li onClick={MenuHandler} className="font-bold my-[10px]">
                        <Link
                          to="/"
                          className="decoration text-white font-bold"
                        >
                          Home
                        </Link>
                      </li>
                      ...
                      <li onClick={MenuHandler} className="font-bold my-[12px]">
                        <Link
                          to="/Cart"
                          className="flex items-center font-bold decoration text-white decoration"
                        >
                          <BsCart3 className="me-2 text-xl relative" />
                          Cart
                          <span
                            class="position-absolute ms-[18px] mb-[8px] translate-middle badge rounded-pill bg-danger"
                            style={{
                ...
                <Link to="/" className=" flex items-center no-underline">
                  ...
                  <h6 className="text-[25px] Hidden ms-3 font-mono mb-0 font-bold text-black">
                    SwiftCart
                  </h6>
                </Link>
              </div>
              ...
              <div className="w-[40%] dis-no flex justify-center just-start w max-lg:relative items-center">
                <div className=" duration-500 transition-all">
                  <ul className="flex demo max-lg:bg-white m-0 gap-[15px] p-0">
                    <li className="font-bold none">
                      <Link
                        to="/"
                        className="a decoration none text-black font-bold"
                      >
                        Home
                      </Link>
                    </li>
                    ...
                    <li className="font-bold  te">
                      <Link
                        to="/Cart"
                        className="flex items-center font-bold text-black a decoration"
                      >
                        <BsCart3 className="me-2 text-xl relative" />
                        Cart
                        <span
